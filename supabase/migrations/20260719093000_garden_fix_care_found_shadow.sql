-- Corrige garden_care_action: a variável local "found" sombreava o FOUND
-- especial do PL/pgSQL, fazendo a função sempre lançar "seedling not found"
-- mesmo com a muda existindo. Com isso, Regar/Podar/Adubar/etc. nunca
-- gravavam no servidor.
