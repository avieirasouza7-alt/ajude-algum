-- Remover pragas sobe +22 por ação (como Regar), em vez de ir direto a 100.
...
BEGIN
  ...
  ELSIF p_kind = 'pest' THEN
    -- Antes ia direto a 100; agora sobe como as outras barras (~22 por clique).
    seedling.pest_free := LEAST(100, seedling.pest_free + 22);
  END IF;
