...
INSERT INTO public.garden_seedlings (
  ...
  ('esperanca-central', 'Árvore da Esperança', 'Ipê-amarelo', 0, 0, 0, 0, 60, 60, 40, 100, 100, 18, 0, 0, now()),
  ('muda-nascente', 'Árvore da Solidariedade', 'Manacá-da-serra', -5, 0, -5, 12, 60, 60, 40, 100, 100, 18, 0, 0, now()),
  ('muda-abraco', 'Árvore da Generosidade', 'Jacarandá', 5, 0, -5, 18, 60, 60, 40, 100, 100, 18, 0, 0, now()),
  ('muda-uniao', 'Árvore da Bondade', 'Pau-brasil', -5, 0, 5, 8, 60, 60, 40, 100, 100, 18, 0, 0, now()),
  ('muda-futuro', 'Campanha União', 'Quaresmeira', 5, 0, 5, 15, 60, 60, 40, 100, 100, 18, 0, 0, now())
ON CONFLICT (id) DO NOTHING;
